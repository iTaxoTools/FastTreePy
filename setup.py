...
setup(
    ...
    description='A sample iTaxoTools project',  # Optional
    ...
    #
    # PyInstaller hooks will be automatically detected if included
    # as entry points like below.
    entry_points = {
        'console_scripts': [
            'sample=itaxotools.sample:main',
            'sample-gui=itaxotools.sample.gui:main',
        ],
        'pyinstaller40': [
